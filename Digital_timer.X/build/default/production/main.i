...
{
    init_config();
    unsigned char key, s_flag = 1;
    while(1)
    {

        key = read_key(2);
        if((key == 1 || key == 2) && s_flag == 1)
        {
                s_flag = 2;
                key = 0;
                i = 0;
        ...
        switch(s_flag)
        {
            case 1 : i=0;
                               read_rtc();
            break;
            case 2 : if((s_flag = edit_screen(key)) != 2)
            {
                i = 0;
                clcd_write(0x01, 0);
                _delay((unsigned long)((500)*(20000000/4000000.0)));
            ...
            break;
            case 4 : if((s_flag = date_time(key)) != 4)
            {
                clcd_write(0x01, 0);
                _delay((unsigned long)((500)*(20000000/4000000.0)));
                get_time();
            ...
            break;
            case 3 : if((s_flag = edit_view_event(key)) != 3)
            {
                clcd_write(0x01, 0);
                _delay((unsigned long)((500)*(20000000/4000000.0)));
                get_time();
            ...
            break;
            case 5 : clcd_print("HH:MM:SS", (0x80 + (4)));
                             s_flag = set_time(key);
            break;
            case 6 : clcd_print("DD:MM:YY", (0x80 + (4)));
                             s_flag = set_date(key);
            break;
            case 8 : view_event(key);
            break;
            case 7 : clcd_print("Time",(0x80 + (0)));
