...
# 1 "./view_edit_event.h" 1
# 11 "./view_edit_event.h"
...
unsigned char set_ev(unsigned char key)
{
    ...
    if(j == 1)
    {
        if(++t < 150)
        {
            clcd_print_ch(' ',(0x80 + (9)));
            clcd_print_ch(' ',(0x80 + (10)));
        }
        else if(t == 300)
            t = 0;
        else
        {
            clcd_print_ch(min/10 + '0',(0x80 + (9)));
            clcd_print_ch(min%10 + '0',(0x80 + (10)));
        }
    }
    else
    {
    ...
    if(j == 2)
    {
        if(++t < 150)
        {
            clcd_print_ch(' ',(0x80 + (6)));
            clcd_print_ch(' ',(0x80 + (7)));
        }
        else if(t == 300)
            t = 0;
        else
        {
            clcd_print_ch(h/10 + '0',(0x80 + (6)));
            clcd_print_ch(h%10 + '0',(0x80 + (7)));
        }
    }
    else
    {
    ...
    if(j == 3)
    {
        ...
        {
            clcd_print_ch(d_h/10 + '0',(0xC0 + (6)));
            clcd_print_ch(d_h%10 + '0',(0xC0 + (7)));
        }
    }
    else if(j==4)
    {
        if(++t < 150)
        {
            clcd_print_ch(' ',(0xC0 + (9)));
            clcd_print_ch(' ',(0xC0 + (10)));
        }
        else if(t == 300)
            t = 0;
        else
        {
            clcd_print_ch(d_min/10 + '0',(0xC0 + (9)));
            clcd_print_ch(d_min%10 + '0',(0xC0 + (10)));
        }
    }
    else if(j == 5)
    {
        if(++t < 150)
        {
            clcd_print_ch(' ',(0xC0 + (12)));
            clcd_print_ch(' ',(0xC0 + (13)));
        }
        else if(t == 300)
            t = 0;
        else
        {
            clcd_print_ch(d_sec/10 + '0',(0xC0 + (12)));
            clcd_print_ch(d_sec%10 + '0',(0xC0 + (13)));
        }
    }
    ...
    clcd_print_ch(':',(0xC0 + (11)));
    if(j != 3)
    {
        clcd_print_ch(d_h/10 + '0',(0xC0 + (6)));
        clcd_print_ch(d_h%10 + '0',(0xC0 + (7)));
    }
    clcd_print_ch(':',(0xC0 + (8)));
    clcd_print_ch(':',(0x80 + (8)));
    clcd_print_ch(' ',(0x80 + (11)));
    return 7;
}
...
void view_event(unsigned char key)
{
    ...
    else
    {
        ...
        clcd_print_ch(log[0],(0x80 + (6)));
        clcd_print_ch(log[1],(0x80 + (7)));
        clcd_print_ch(':',(0x80 + (8)));
        clcd_print_ch(log[2],(0x80 + (9)));
        clcd_print_ch(log[3],(0x80 + (10)));
        clcd_print_ch(' ',(0x80 + (11)));
        clcd_print_ch(log[4],(0x80 + (12)));
        clcd_print_ch(log[5],(0x80 + (13)));
        clcd_print("DUR -",(0xC0 + (0)));
        clcd_print_ch(log[6],(0xC0 + (6)));
        clcd_print_ch(log[7],(0xC0 + (7)));
        clcd_print_ch(':',(0xC0 + (8)));
        clcd_print_ch(log[8],(0xC0 + (9)));
        clcd_print_ch(log[9],(0xC0 + (10)));
        clcd_print_ch(':',(0xC0 + (11)));
        clcd_print_ch(log[10],(0xC0 + (12)));
        clcd_print_ch(log[11],(0xC0 + (13)));
    }
}
