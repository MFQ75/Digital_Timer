...
void get_time()
{
    ...
    min = ((time[3]<<4) | time[4]);
    sec = ((((read_ds1307(0x00) >> 4) & 0x07) + '0') | ((read_ds1307(0x00) >> 4) & 0x0F + '0'));
...
void read_rtc()
{
    ...
    date[0] = ((read_ds1307(0x04)>> 4) & 0x03) + '0';
    date[1] = (read_ds1307(0x04) & 0x0F) + '0';
    date[2] = '-';
    date[3] = ((read_ds1307(0x05) >> 4) & 0x01) + '0';
    date[4] = (read_ds1307(0x05) & 0x0F) + '0';
    date[5] = '-';
    date[6] = ((read_ds1307(0x06)>> 4)& 0x0F) + '0';
    date[7] = (read_ds1307(0x06)&0x0F) + '0';
    date[8] = '\0';
...
unsigned char edit_screen(unsigned char key)
{
    ...
    if(i == 0)
    {
        ...
        clcd_print(ch[i],(0x80 + (2)));
        clcd_print_ch('*',(0x80 + (0)));
        clcd_print(ch[i+1],(0xC0 + (2)));
    }
    else
    {
        clcd_print_ch(' ',(0x80 + (0)));
        clcd_print(ch[i-1],(0x80 + (2)));
        clcd_print_ch('*',(0xC0 + (0)));
        clcd_print(ch[i],(0xC0 + (2)));
    }
    return 2;
}
