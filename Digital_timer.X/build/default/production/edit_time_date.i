...
unsigned char set_time(unsigned char key)
{
    ...
    if(j == 0)
    {
        ...
        {
            clcd_print_ch(sec/10 + '0',(0xC0 + (10)));
            clcd_print_ch(sec%10 + '0',(0xC0 + (11)));
        }
    ...
    else if(j == 1)
    {
        ...
        {
            clcd_print_ch(min/10 + '0',(0xC0 + (7)));
            clcd_print_ch(min%10 + '0',(0xC0 + (8)));
        }
    }
    else if(j == 2)
    {
        ...
        {
            clcd_print_ch(h/10 + '0',(0xC0 + (4)));
            clcd_print_ch(h%10 + '0',(0xC0 + (5)));
        }
    }
...
unsigned char set_date(unsigned char key)
{
    ...
    else if(key == 1)
    {
        ...
        while(read_key(1) == 1)
        {
            if(++long_press == 50000)
            {
                ...
                write_ds1307(0x06,num);
                num = ((month/10)<<4) | (month%10);
                write_ds1307(0x05,num);
                num = ((d/10)<<4) | (d%10);
                write_ds1307(0x04,num);
                return 1;
            }
        }
    }
    if(j == 0)
    {
        ...
        {
            clcd_print_ch(year/10 + '0',(0xC0 + (10)));
            clcd_print_ch(year%10 + '0',(0xC0 + (11)));
        }
    }
    else if(j == 1)
    {
        ...
        {
            clcd_print_ch(month/10 + '0',(0xC0 + (7)));
            clcd_print_ch(month%10 + '0',(0xC0 + (8)));
        }
    }
    else if(j == 2)
    {
        ...
        {
            clcd_print_ch(d/10 + '0',(0xC0 + (4)));
            clcd_print_ch(d%10 + '0',(0xC0 + (5)));
        }
    }
    if(j != 2)
    {
